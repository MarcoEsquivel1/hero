...
@section('content')
    ...
    <div class="row my-3">
        <div class="col-auto">
            <a class="btn  btn-primary" href="{{route('hero.create')}}" role="button">Crear</a>
        </div>
    </div>
                ...
                @foreach ($heroes as $hero)
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col-auto">
                                    <a class="btn  btn-warning" href="{{route('hero.edit', ['hero'=> $hero->id]) }}" role="button">Modificar</a>
                                </div>
                                <div class="col-auto">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('hero.destroy', ['hero'=>$hero->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
